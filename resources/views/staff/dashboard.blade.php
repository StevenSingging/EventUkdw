...
<style>
    .timeline {
        max-height: 500px;
        /* Ganti tinggi sesuai kebutuhan Anda */
        overflow-y: auto;
    }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            eventClick: function({
                ...
                var hargastaff = eventData.extendedProps.harga_staff;
                ...
                var hargaText = hargastaff !== null ? '<p>' + '<i class="fa-solid fa-money-bill fa-md mr-2" style="color:cadetblue"></i>' + hargastaff + '</p>' : '';
                ...
                modal.find('.modal-body').html(
                    ...
                    hargaText + '<p>' + '<i class="fa-solid fa-users fa-md mr-2" style="color:cadetblue"></i>'+ kouta +'</p>' + '<p>' + '<i class="fa-solid fa-clock fa-md mr-2" style="color:cadetblue"></i>' + mulai +' WIB </p>'
